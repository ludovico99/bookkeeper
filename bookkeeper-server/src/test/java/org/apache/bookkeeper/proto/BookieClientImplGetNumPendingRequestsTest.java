...
public class BookieClientImplGetNumPendingRequestsTest extends BookKeeperClusterTestCase {
    ...
    public void set_up() {
        try {
            ...
            DefaultPerChannelBookieClientPool pool = new DefaultPerChannelBookieClientPool(this.clientConf, this.bookieClientImpl,
                    bookieId, 1);
            ...
            doNothing().when(spyInstance).errorOutOutstandingEntries(isA(int.class));
            ...
            counter.i = Math.toIntExact(this.numberPendingRequestToInsert);
            ...
            if (this.clientConfType == ClientConfType.CLOSED_CONFIG){
