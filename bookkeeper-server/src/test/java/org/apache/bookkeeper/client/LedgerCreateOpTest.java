...
public class LedgerCreateOpTest extends BookKeeperClusterTestCase {
    ...
    public void Test_Initiate() {
         ...
         try {
             ...
             //E' sincrona poichè chiama la waitForResult
//                bkc.createLedger(ensembleSize,writeQuorumSize,ackQuorumSize, BookKeeper.DigestType.CRC32,"pwd".getBytes(StandardCharsets.UTF_8),
//                        null);
//
             ...
             if ((int) this.expectedException == BKException.Code.ZKException) verifyNoInteractions(this.cb);
    ...
    private SyncCallbackUtils.SyncCreateCallback createCallback(){
